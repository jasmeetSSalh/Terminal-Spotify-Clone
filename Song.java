...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	{
		if(this.artist.equals(((Song)other).artist) && this.composer.equals(((Song)other).composer))
	...
	{
		return this.getTitle().compareTo(other.getTitle()); 	// Compare the titles of the two songs
	}
